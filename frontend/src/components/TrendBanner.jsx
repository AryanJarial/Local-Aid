...
const TrendBanner = ({ userLocation }) => {
    ...
    return (
        <div className={`rounded-2xl shadow-xl p-6 mb-8 text-white relative overflow-hidden transform hover:scale-[1.01] transition-transform duration-300 ${hasActivity
            ...
            <div className="h-25 z-10 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap gap-4 justify-center md:justify-end">
                    ...
                    {!hasActivity && (
                        <Link
                            to="/create-post"
                            className="bg-white/20 backdrop-blur-md border border-white/30 px-4 py-2 rounded-lg animate-pulse hover:bg-white/30 transition-colors cursor-pointer"
                        >
